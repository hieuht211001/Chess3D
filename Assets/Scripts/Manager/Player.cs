...
public class Player : MonoBehaviour
{
    ...
    public void Init(TEAM_SIDE teamSide, BoardLogic board, PiecesUI pieceUI, CaptureQueue captureQueue)
    {
    ...
    public void DeSelectAllPiece()
    {
        this.selectedPiece = null;
        foreach (IPieces pieceComponenent in pieceList)
        {
            pieceComponenent.DeSelectPiece();
        }
    }
    ...
    public void MoveSelectedPiece(CoordXY newPos)
    {
        ...
        var moveCommand = new MoveCommand(this.boardLogic, selectedPiece, newPos, captureQueue);
